...
var _a, _b;
const logo = new URL(new URL('DstkarBv.svg', import.meta.url).href, import.meta.url).href;
let TodoApp = class TodoApp2 extends h {
  constructor() {
    super(...arguments);
    this.header = "My app";
  }
  render() {
    return ke(_a || (_a = __template(['\n      <main>\n        <div class="logo"><img alt="open-wc logo" src=', " /></div>\n        <h1>", '</h1>\n\n        <p>Edit <code>src/TodoApp.ts</code> and save to reload.</p>\n        <a\n          class="app-link"\n          href="https://open-wc.org/guides/developing-components/code-examples"\n          target="_blank"\n          rel="noopener noreferrer"\n        >\n          Code examples\n        </a>\n      </main>\n\n      <p class="app-footer">\n        \u{1F6BD} Made with love by\n        <a\n          target="_blank"\n          rel="noopener noreferrer"\n          href="https://github.com/open-wc"\n          >open-wc</a\n        >.\n      </p>\n    '])), logo, this.header);
  }
};
TodoApp.styles = i$1(_b || (_b = __template(["\n    :host {\n      min-height: 100vh;\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: flex-start;\n      font-size: calc(10px + 2vmin);\n      color: #1a2b42;\n      max-width: 960px;\n      margin: 0 auto;\n      text-align: center;\n      background-color: var(--todo-app-background-color);\n    }\n\n    main {\n      flex-grow: 1;\n    }\n\n    .logo {\n      margin-top: 36px;\n      animation: app-logo-spin infinite 20s linear;\n    }\n\n    @keyframes app-logo-spin {\n      from {\n        transform: rotate(0deg);\n      }\n      to {\n        transform: rotate(360deg);\n      }\n    }\n\n    .app-footer {\n      font-size: calc(12px + 0.5vmin);\n      align-items: center;\n    }\n\n    .app-footer a {\n      margin-left: 5px;\n    }\n  "])));
__decorate([n({
  type: String
})], TodoApp.prototype, "header", void 0);
TodoApp = __decorate([t("todo-app")], TodoApp);
